...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 flex flex-col md:flex-row grid-bg">
      {/* Sidebar Desktop */}
      <aside className="hidden md:flex flex-col w-64 bg-white/80 backdrop-blur-md border-r border-slate-200/60 sticky top-0 h-screen z-20">
        ...
        <div className="p-4 border-t border-slate-100/80 bg-white/40 shrink-0">
          ...
          <button
            ...
            className="w-full flex items-center space-x-3 px-4 py-3 text-slate-600 hover:bg-rose-50 hover:text-rose-600 rounded-xl transition-all font-medium text-sm cursor-pointer"
          >
